public class DemosWOAug16 {
	
  public static void main(String[] args) {
  	
  	
  	//DemosWOAug16.Demo4(); // compare ternary with if-else   	
    //DemosWOAug16.Demo5(); // overview of for loop  	
  	//DemosWOAug16.Demo2(); // ext for loop parts  	
  	//DemosWOAug16.Demo1(); // linear search | break
  	//DemosWOAug16.Demo6(); // forward and reverse for loop 	
  	//DemosWOAug16.Demo3(); // while <vs> do-while
  } // Ends Method Main
